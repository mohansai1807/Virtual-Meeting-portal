...
export default function VideoMeetComponent() {
    ...
    const displayMediaSuccessRef = useRef();
    ...
    const getDislayMedia = useCallback(() => {
        if (screen && navigator.mediaDevices.getDisplayMedia) {
            navigator.mediaDevices.getDisplayMedia({ video: true, audio: true })
                .then((stream) => displayMediaSuccessRef.current(stream))
                .then(() => { })
    ...
    userMediaRef.current = getUserMedia;
    ...
    displayMediaSuccessRef.current = getDislayMediaSuccess;
